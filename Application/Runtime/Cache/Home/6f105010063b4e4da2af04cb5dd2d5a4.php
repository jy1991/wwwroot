    	...
    	<div class="col-md-12">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo ($vo["pro_info"]["name"]); ?></td>
					<td>
						<select>
					...
					<td style="width:30px;">
							<div id="tsShopContainer" style="width:36px">
								<div id="tsImgS"><a href="/wwwroot/Uploads/<?php echo ($vo["img"]["path"]); echo ($vo["img"]["name"]); ?>" title="<?php echo ($vo["pro_info"]["ad"]); ?>" class="MagicZoom" id="MagicZoom"><img width="24" src="/wwwroot/Uploads/<?php echo ($vo["img"]["path"]); echo ($vo["img"]["name"]); ?>" /></a></div>
								
							</div>
							<script src="js/ShopShow.js"></script>			
					</td>
					<td><?php echo ($vo["pro_info"]["price"]); ?></td>
...
<div id="count">
    <a id="order" href="<?php echo U('Order/index', array('id'=>$vo['id']));?>" class="btn btn-danger btn-lg">结算</a>
    <a href="<?php echo U('Index/index');?>" class="btn btn-info btn-lg">继续购物</a>

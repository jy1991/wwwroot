...
<html lang="zh-CN">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/huawei/Public/Dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="/huawei/Public/Dist/css/index.css" rel="stylesheet">
    <link href="/huawei/Public/Dist/css/login.css" rel="stylesheet">
    <script type="text/javascript" src="/huawei/Public/assets/js/jquery-2.0.3.min.js"></script>
  ...
  <div class="container-fluid  nav-height">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right nav-height">
        ...
        <li>
              <?php if(empty($_SESSION['home_user'])): ?><a href="<?php echo U('User/add');?>">注册</a>
...
<header class="header">
  <div class="layout m0a">
    <div class="logo"><a href="<?php echo U('Index/index');?>" title="Vmall.com - 华为商城"><img src="/huawei/Public/Dist/images/newLogo.png" alt="Vmall.com - 华为商城"/></a></div>
    <div class="searchBar">
    <!-- 页头热门搜索 -->
    ...
    <!-- -迷你购物车-start -->
    <div class="minicart">
        <div class="h" id="header-toolbar-minicart-h"><a href="http://cart.vmall.com/cart/cart.html?t=1455600335222timestamp" rel="nofollow" timeType="timestamp">我的购物车<span><em id="header-cart-total">0</em><b></b></span></a><i></i><s></s><u></u></div>
			...
			<div class="ec-slider" id="ec-erweima">
				<ul class="ec-slider-list">
					<li class="ec-slider-item">
						<p><a href="http://www.vmall.com/appdownload" target="blank" title="扫码下载客户端"><img src="/huawei/Public/Dist/images/qrcode_vmall_app01.png" alt="华为商城官方客户端"/></a></p>
						<p><a href="http://www.vmall.com/appdownload" target="blank"><span>扫码下载客户端</span></a></p>
					</li>
					<li class="ec-slider-item">
						<p><a href="http://www.vmall.com/appdownload" target="blank" title="微信扫码关注我们"><img src="/huawei/Public/Dist/images/qrcode_vmall_wechat01.jpg" alt="华为商城官方微信"/></a></p>
  ...
  <div class="layout">
    ...
    <nav class="naver">
      <ul id="naver-list">
        ...
        荣耀全球情人节
        <s>
        <img alt="new" src="/huawei/Public/Dist/images/new.png">
        </s>
        </span>       
        </a> 
        </li>
...
<script type="text/javascript">
  $(document).ready(function(){
     ...
     yzm_img.click(function(){
         yzm_img.attr('src','<?php echo U('verify');?>?random='+time);
     })
...
<!--注册用户-->
<div id="main_content">
    <form class="form-horizontal"  action='<?php echo U("register");?>' method='post'>
         ...
         <div class="form-group">
          <label for="yzm" class="col-sm-3 control-label">验证码</label>
            ...
            <div class="col-sm-3" id="yzm_img">
              <img src="<?php echo U('verify',array());?>" alt="验证码" title="点击刷新">
            </div>
         </div>
        <div class="form-group">
